    ...
    return (
        <div className="min-h-screen flex flex-col bg-[#121212] text-[#F5F5F5] selection:bg-[#F97316] selection:text-white">
            ...
            <main className="flex-1">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-12">
                            <div className="lg:col-span-8 space-y-6">
                                ...
                                <p className="text-base sm:text-lg md:text-xl text-[#A3A3A3] font-normal max-w-2xl leading-relaxed">
                                    One note. Everyone’s cursor. An editorial
                                    collaborative editor built with
                                    deterministic state vector sync, zero
                                    handoff friction, and a quiet, brutalist UI.
                                </p>
                            ...
                            <div className="lg:col-span-4 space-y-6 border-l border-[#262626] lg:pl-8 pt-4 lg:pt-0">
                                <div className="space-y-2">
                                    ...
                                    <p className="font-mono-tech text-xs text-[#A3A3A3] leading-relaxed">
                                        Designed for teams who refuse to trade
                                        editorial rigor for collaborative chaos.
                                        No floating bubbles, no generic
                                        templates.
                                    </p>
                                </div>
                                ...
                                <div className="space-y-2 pt-4 border-t border-[#262626]">
                                    ...
                                    <p className="font-mono-tech text-xs text-[#A3A3A3] leading-relaxed">
                                        Powered by Conflict-free Replicated Data
                                        Types (CRDT). State vector sync resolves
                                        edits concurrently without server
                                        lockouts.
                                    </p>
                                </div>
                            </div>
                ...
                <section
                    id="demo"
                    className="py-16 sm:py-20 border-b border-[#262626] bg-[#121212]"
                >
                    <div className="max-w-7xl mx-auto px-4 md:px-8">
                        <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
                            ...
                            <p className="font-mono-tech text-xs text-[#A3A3A3] max-w-md">
                                Live document state synchronization with low
                                latency, word counters, and active collaborator
                                presence.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 border border-[#333333] divide-y md:divide-y-0 md:divide-x divide-[#333333] bg-[#1E1E1E]">
                            ...
                            <div className="p-6 sm:p-8 space-y-4 hover:bg-[#262626] transition-colors">
                                ...
                                <p className="text-xs sm:text-sm text-[#A3A3A3] leading-relaxed">
                                    Multiple writers edit the exact same
                                    paragraph simultaneously. CRDT algorithms
                                    guarantee convergence without overwriting
                                    keystrokes.
                                </p>
                            ...
                            <div className="p-6 sm:p-8 space-y-4 hover:bg-[#262626] transition-colors">
                                ...
                                <p className="text-xs sm:text-sm text-[#A3A3A3] leading-relaxed">
                                    Designed for deep writing focus. Precise
                                    line lengths, comfortable vertical rhythm,
                                    crisp monochromes, and zero UI clutter.
                                </p>
                                <div className="pt-4 border-t border-[#333333] font-mono-tech text-[10px] text-[#737373]">
                            ...
                            <div className="p-6 sm:p-8 space-y-4 hover:bg-[#262626] transition-colors">
                                ...
                                <p className="text-xs sm:text-sm text-[#A3A3A3] leading-relaxed">
                                    Write offline seamlessly. Local delta
                                    changes buffer locally in IndexedDB and
                                    reconcile automatically upon reconnect.
                                </p>
                                <div className="pt-4 border-t border-[#333333] font-mono-tech text-[10px] text-[#737373]">
                ...
                <section
                    id="specs"
                    className="py-16 sm:py-20 border-b border-[#262626] bg-[#0A0A0A] text-white"
                >
                    <div className="max-w-7xl mx-auto px-4 md:px-8">
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                            <div className="lg:col-span-5 space-y-6">
                                ...
                                <p className="text-xs sm:text-sm text-[#A3A3A3] leading-relaxed">
                                    CollabNote operates at the boundary of web
                                    sockets and binary state vectors.
                                    Microsecond latency ensures fluid
                                    co-authoring across continents.
                                </p>
                            </div>
                            ...
                            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4 font-mono-tech text-xs">
                                <div className="border border-[#262626] p-5 sm:p-6 bg-[#171717] space-y-2">
                                    ...
                                    <p className="text-[10px] text-[#737373]">
                                        Mathematical deterministic final
                                        consistency.
                                    </p>
                                </div>
                                ...
                                <div className="border border-[#262626] p-5 sm:p-6 bg-[#171717] space-y-2">
                                    ...
                                    <p className="text-[10px] text-[#737373]">
                                        Direct binary stream serialization.
                                    </p>
                                </div>
                                ...
                                <div className="border border-[#262626] p-5 sm:p-6 bg-[#171717] space-y-2">
                                    ...
                                    <p className="text-[10px] text-[#737373]">
                                        End-to-end socket TLS protocol.
                                    </p>
                                </div>
                                ...
                                <div className="border border-[#262626] p-5 sm:p-6 bg-[#171717] space-y-2">
                                    ...
                                    <p className="text-[10px] text-[#737373]">
                                        Zero runtime bloat or garbage spikes.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <section className="py-20 sm:py-24 bg-[#121212] text-[#F5F5F5]">
                    <div className="max-w-4xl mx-auto px-4 text-center space-y-6 sm:space-y-8">
                        ...
                        <p className="font-mono-tech text-xs sm:text-sm text-[#A3A3A3] max-w-xl mx-auto">
                            Create an account or login to access your
                            collaborative notes workspace immediately.
                        </p>
