        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-12 border-b border-[#262626]">
          ...
          <div className="space-y-4 md:col-span-2">
            ...
            <p className="font-mono-tech text-xs text-[#A3A3A3] max-w-md leading-relaxed">
              An experimental, editorial collaborative editor. High-frequency state vector synchronization without handoffs or UI distraction.
            </p>
            <div className="flex items-center gap-4 pt-2">
              <TechnicalAnnotation label="STATUS" value="NORMAL" variant="accent" />
              <TechnicalAnnotation label="LATENCY" value="< 4ms" variant="light" />
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 font-mono-tech text-xs">
              ...
              <li>
                <Link href="#specs" className="hover:text-[#F97316] transition-colors">
                  03. Technical Specs
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 font-mono-tech text-xs">
              <li>
                <Link href="/login" className="hover:text-[#F97316] transition-colors">
                  Login to Workspace
                </Link>
              </li>
              <li>
                <Link href="/signup" className="hover:text-[#F97316] transition-colors">
                  Create New Account
                </Link>
              </li>
              <li>
                <span className="text-[#525252]">API Docs (v1)</span>
              </li>
            </ul>
          </div>
        </div>
